...
public class WordCount {
    private static final String STREAM_ID = "streams-wordcount";
    private static final String SOURCE_TOPIC = "streams-plaintext-input";
    private static final String TO_TOPIC = "streams-wordcount-output";
    public static void main(String[] args) {
        ...
        builder.<String, String>stream(SOURCE_TOPIC)
               ...
               .toStream()
               .to(TO_TOPIC, Produced.with(Serdes.String(), Serdes.Long()));
